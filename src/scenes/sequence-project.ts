...
export type SceneState = Pick<Project, 'duration' | 'fps' | 'aspect' | 'room' | 'entities' | 'cuts' | 'references' | 'production' | 'floors' | 'editorView'>;
const stateKeys = ['duration', 'fps', 'aspect', 'room', 'entities', 'cuts', 'references', 'production', 'floors', 'editorView'] as const;
