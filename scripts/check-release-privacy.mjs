...
const extraFiles = ['desktop/main.cjs', 'desktop/preload.cjs', 'desktop/integration.cjs', 'desktop/media-import.cjs', 'desktop/ai-host.cjs', 'desktop/ai-conversation.cjs', 'desktop/providers.cjs', 'desktop/model-limits.cjs', 'desktop/director-prompt.cjs', 'desktop/mcp-server.cjs', 'desktop/mcp-config.cjs', 'desktop/mcp-host.cjs', 'skills/director-desk/SKILL.md', 'skills/director-desk/references/project-format.md', 'skills/director-desk/references/online-workflow.md', 'skills/director-desk/scripts/project-tool.mjs', 'skills/director-desk/assets/minimal.director'];
