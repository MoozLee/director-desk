...
await page.locator(`[data-select="${id}"]`).click();await page.locator('[data-inspect="deform"]').click();await page.locator('#deform-type').selectOption('twist');
...
await page.locator('[data-inspect="curves"]').click();assert.ok((await page.locator('#inspector-content').textContent()).includes('amount'));
await page.locator('[data-inspect="surface"]').click();await page.locator('#surface-page').selectOption('appearance');
await page.evaluate(()=>window.__director.setTime(0));await page.locator('[data-surface-field="appearance.transmission"]').fill('0.23');await page.locator('[data-surface-action="key"]').click();
await page.evaluate(()=>window.__director.setTime(2));await page.locator('[data-surface-field="appearance.transmission"]').fill('0.87');await page.locator('[data-surface-action="key"]').click();
